            ...
            return (
              <div id="careerList">
                <input
                  ...
                  value="-"
                  onClick={(e) => {
                    handleRemoveClick(careerList, i, e);
                  }}
                />
                <input
                  type="text"
          ...
          return (
            <div id="schoolList">
              <input
                ...
                value="-"
                onClick={(e) => {
                  handleRemoveClick(schoolList, i, e);
                }}
              />
              <select
                name="schoolType"
          ...
          return (
            <div id="certList">
              <input
                ...
                value="-"
                onClick={(e) => {
                  handleRemoveClick(certList, i, e);
                }}
              />
              <input
                type="text"
          ...
          return (
            <div id="awardList">
              <input
                ...
                value="-"
                onClick={(e) => {
                  handleRemoveClick(awardList, i, e);
                }}
              />
              <input
                type="text"
            ...
            return (
              <div id="introList">
                <textarea
                  ...
                  value={x.introShort}
                  onChange={(e) => {
                    handleInputChange(introList, i, e);
                  }}
                />
                <textarea
                  id="introLong"
          ...
          return (
            <div id="snsList">
              <input
                ...
                type="button"
                value="-"
                onClick={(e) => handleRemoveClick(snsList, i, e)}
              />
              <input
                type="text"
                name="sns"
          ...
          return (
            <div id="stackList">
              <input
                ...
                value="-"
                onClick={(e) => {
                  handleRemoveClick(stackList, i, e);
                }}
              />
              <input
                type="text"
