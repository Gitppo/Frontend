  ...
  return (
    < div className="container" >
      ...
      <div className="etc">
        ...
        <div id="infoList">
          경력사항
          <input className="button" type="button" value="+" onClick={addItem}></input>
          <div id="careerList">
            <input className="button" type="button" value="-" onClick={removeItem}></input>
            <input type="text" name="company" placeholder="회사명" size="15"></input>
            <input type="text" name="depart" placeholder="부서명" size="10"></input>
            <input type="month" name="start" required></input>~
            <input type="month" name="end"></input>
            <input type="text" name="position" placeholder="직위" size="10"></input>
            <input type="text" name="job" placeholder="직무" size="10"></input>
          </div>
          <div id="careerField"></div>
          <br></br>
          학력사항
          <input className="button" type="button" value="+" onClick={addItem2}></input>
          <div id="schoolList">
            <input className="button" type="button" value="-" onClick={removeItem}></input>
          ...
          <br></br>
          자격/어학사항
          <input className="button" type="button" value="+" onClick={addItem3}></input>
          <div id="certList">
            <input className="button" type="button" value="-" onClick={removeItem}></input>
            <input type="text" name="cert" placeholder="자격/어학 종류"></input>
            <input type="text" name="level" placeholder="등급/레벨/점수"></input>
          ...
          <br></br>
          수상경력
          <input className="button" type="button" value="+" onClick={addItem4}></input>
          <div id="awardList">
            <input className="button" type="button" value="-" onClick={removeItem}></input>
          ...
          <br></br>
          기타
          <input className="button" type="button" value="+" onClick={addItem5}></input>
          <div id="etcList">
            <input className="button" type="button" value="-" onClick={removeItem}></input>
          ...
          <div id="intro">
            자기소개
             <div id="introList">
              ...
              <textarea name="introLong" cols="30" rows="10" placeholder="자기소개"></textarea>
            </div>
          </div>
          <br></br>
          SNS
          <input className="button" type="button" value="+" onClick={addItem6}></input>
          <div id="snsList">
            <input className="button" type="button" value="-" onClick={removeItem}></input>
